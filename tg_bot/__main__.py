...
And don't forget to subscribe to the tech gaming youtube channel below.
...
It took lots of work for [my creator](t.me/RubinaDilaiks) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
There are two ways of paying him; [Paytm](https://paytm.me/82x-DRl)."""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Join YouTube", url="https://youtu.be/W6CLKrehy6w")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/ViralEarner"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/Hifilootapp")],
                     [InlineKeyboardButton(text="👨‍💻 Developer", url="https://t.me/RubinaDilaiks"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
